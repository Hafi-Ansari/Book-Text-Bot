...
const fs = require("fs");
const { proximitySearch } = require("../database");

module.exports = {
  data: new SlashCommandBuilder()
    .setName("proximity-search")
    .setDescription("This can be useful if a user remembers several words from a quote, but not their exact order.")
